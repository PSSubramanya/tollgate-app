...
class RegisterLoaderPage extends StatefulWidget {
  @override
  State createState() => new RegisterLoaderPageState();
  // State<StatefulWidget> createState() {
  //   return HomeDisplayState();
}

class RegisterLoaderPageState extends State<RegisterLoaderPage> {
  @override
  void initState() {
  ...
  route() {
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => UserEntryPage()));
