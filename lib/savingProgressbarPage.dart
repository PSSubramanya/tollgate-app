...
class SavingProgreesPage extends StatefulWidget {
  @override
  State createState() => new SaveState();
  // State<StatefulWidget> createState() {
  //   return HomeDisplayState();
}

class SaveState extends State<SavingProgreesPage> {
  @override
  void initState() {
  ...
  route() {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => TravelEntryPage()));
  }
